...
class FireWallUserStatMon(object):
    def __init__(self):
        self.plugin_name = "firewall_traffic_rate_stat"
        self.interval = 5
    ...
    def read_callback(self):
        try:
            ...
            # for ip, value in internet_delta_stat.iteritems():
                ...
                self.dispatch_value(self.plugin_name, host, "src_bytes", type_instance, plugin_instance, value[0]/interval)
                self.dispatch_value(self.plugin_name, host, "src_packets", type_instance, plugin_instance, value[1]/interval)
                self.dispatch_value(self.plugin_name, host, "dst_bytes", type_instance, plugin_instance, value[2]/interval)
                self.dispatch_value(self.plugin_name, host, "dst_packets", type_instance, plugin_instance, value[3]/interval)
