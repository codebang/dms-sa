...
class StartCommand(Subcommand):
    def __init__(self):
        ...
        self.parser.add_option('-f','--firewall',action = "extend",dest="firewall_interface",default=["eth0"])
        self.parser.add_option('-i','--ipsecvpn',action = "extend",dest="ipsecvpn_interface",default=["eth0"])
        self.parser.add_option('-d','--dns',action = "extend",dest="dns_interface",default=["eth0"])
        self.parser.add_option('-v','--vrouter',action = "extend",dest="vrouter_interface",default=["eth0"])
    ...
    def execute(self,options,subargs):
        ...
        try:
            ...
            map["ispecvpn"] = options.ipsecvpn_interface
